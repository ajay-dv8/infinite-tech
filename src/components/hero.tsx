...
//   return (
//     <div className="relative max-h-[100dvh] w-full flex items-center justify-center overflow-hidden bg-[#030303]">
...
//         <div className="max-w-3xl mx-auto text-center relative -top-80">
//           {/* <motion.div
//             custom={0}
