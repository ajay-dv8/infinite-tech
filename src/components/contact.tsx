    ...
    <section className="px-4 md:px-20 bg-[#eff1f5] text-gray-800">
      ...
      <div className="flex justify-between flex-col mt-20 pb-10 md:mt-40 md:flex-row gap-8">
        ...
        >
          ...
          <p className="font-semibold hover:underline">{generalInfo.email}</p>
        </a>

        <a
          href={`tel:${generalInfo.phoneLink}`}
          className="flex items-center flex-col md:items-start"
        >
          <span className="mb-3 flex size-12 flex-col items-center justify-center rounded-full bg-accent">
          ...
          <p className="font-semibold hover:underline">{generalInfo.phone}</p>
        </a>
